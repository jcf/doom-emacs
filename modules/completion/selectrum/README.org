...
=SPC f f=/=SPC .= support exported to a =wdired= buffer using =C-c C-e=.
...
literally.
Doom has some builtin [[https://github.com/oantolin/orderless#style-dispatchers][style dispatchers]] for more finegrained filtering.
